...
urlpatterns = [
    ...
    path('gerenciar_pedidos/', views.gerenciar_pedidos,
    ...
    path('permitir_abrir_exame/<int:exame_id>', views.permitir_abrir_exame,
         name="permitir_abrir_exame"),
    path('permitir_abrir_exame/<int:exame_id>', views.permitir_abrir_exame,
         name="permitir_abrir_exame"),
    path('solicitar_senha_exame/<int:exame_id>', views.solicitar_senha_exame,
         name="solicitar_senha_exame"),
    path('gerar_acesso_medico/', views.gerar_acesso_medico,
         name="gerar_acesso_medico"),
    path('acesso_medico/<str:token>', views.acesso_medico,
         name="acesso_medico"),
]
